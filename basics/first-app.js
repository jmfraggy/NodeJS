...
// run from terminal with node first-app.js

const fs = require('fs');

fs.writeFileSync('hello.txt', 'Hello from Node.js');

// Node.js run JS from the server
// and return data that the users can use.
...
// Run Server - Create & Listen to Incoming Rquests
// Business Logic - Handle Requests, Validate Input, Connect to Database
// Responses - Return Responses (Rendered HTML, JSON, ...)

// Alternatives for Node.js are: 
// Python(Flask or Jango), PHP (laravel), Ruby, ASP.NET

// Front End 

// Highly performance and trending
